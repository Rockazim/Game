...
#define LOW_PRECISION`),t}function xp(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===rl?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===ol?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sn&&(t="SHADOWMAP_TYPE_VSM"),t}function yp(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case mi:case gi:t="ENVMAP_TYPE_CUBE";break;case ks:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Mp(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case gi:t="ENVMAP_MODE_REFRACTION";break}return t}function Sp(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Mo:t="ENVMAP_BLENDING_MULTIPLY";break;case wc:t="ENVMAP_BLENDING_MIX";break;case bc:t="ENVMAP_BLENDING_ADD";break}return t}function Ep(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function wp(s,t,e,n){const i=s.getContext(),r=e.defines;let o=e.vertexShader,a=e.fragmentShader;const l=xp(e),c=yp(e),h=Mp(e),u=Sp(e),d=Ep(e),p=up(e),g=dp(r),_=i.createProgram();let m,f,w=e.glslVersion?"#version "+e.glslVersion+`
...
`].filter(Ii).join(`
`)),o=fo(o),o=Da(o,e),o=Ua(o,e),a=fo(a),a=Da(a,e),a=Ua(a,e),o=Na(o),a=Na(a),e.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+f);const y=w+m+o,S=w+f+a,N=La(i,i.VERTEX_SHADER,y),A=La(i,i.FRAGMENT_SHADER,S);i.attachShader(_,N),i.attachShader(_,A),e.index0AttributeName!==void 0?i.bindAttribLocation(_,0,e.index0AttributeName):e.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(P){if(s.debug.checkShaderErrors){const B=i.getProgramInfoLog(_).trim(),F=i.getShaderInfoLog(N).trim(),H=i.getShaderInfoLog(A).trim();let X=!0,G=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(X=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(i,_,N,A);else{const j=Ia(i,N,"vertex"),V=Ia(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
void main() {
    ...
    `,document.body.appendChild(t),this.ui={connectionStatus:document.getElementById("connection-status"),roomControls:document.getElementById("room-controls"),roomInfo:document.getElementById("room-info"),roomList:document.getElementById("room-list"),showRoomList:e=>{if(!e||e.length===0){this.ui.roomList.innerHTML="<div>No rooms available</div>";return}this.ui.roomList.innerHTML=e.map(n=>`
        ...
        `).join("")},hideRoomList:()=>{this.ui.roomControls.style.display="none",this.ui.roomInfo.style.display="block"},showNotification:e=>{console.log(`[Notification] ${e}`)},showError:e=>{console.error(`[Error] ${e}`)},showDisconnected:()=>{this.ui.connectionStatus.textContent="Disconnected",this.ui.connectionStatus.style.color="red"}},document.getElementById("create-room").addEventListener("click",()=>{const e=prompt("Enter room name:")||"New Room";this.multiplayer.createRoom(e,10)}),document.getElementById("join-room").addEventListener("click",()=>{const e=prompt("Enter room ID:");e&&this.multiplayer.joinRoom(e)}),document.getElementById("leave-room").addEventListener("click",()=>{this.multiplayer.leaveRoom(),this.ui.roomControls.style.display="block",this.ui.roomInfo.style.display="none"}),setTimeout(()=>{this.multiplayer&&this.multiplayer.connected&&(this.ui.connectionStatus.textContent="Connected",this.ui.connectionStatus.style.color="lime")},1e3)}joinRoom(t){this.multiplayer&&this.multiplayer.joinRoom(t)}createRemotePlayer(t){var h,u,d;const e=t.team||(Math.random()>.5?"ct":"t"),n=new sl({team:e,isLocalPlayer:!1,showArms:!0}),i=n.getModel();i.position.set(((h=t.position)==null?void 0:h.x)||0,((u=t.position)==null?void 0:u.y)||0,((d=t.position)==null?void 0:d.z)||0);const r=document.createElement("canvas");r.width=256,r.height=64;const o=r.getContext("2d");o.fillStyle="rgba(0, 0, 0, 0.5)",o.fillRect(0,0,256,64),o.fillStyle="white",o.font="bold 28px Arial",o.textAlign="center",o.fillText(t.username||"Player",128,40);const a=new Uo(r),l=new Ws({map:a,depthTest:!1,depthWrite:!1}),c=new On(l);return c.scale.set(2,.5,1),c.position.y=3.2,i.add(c),this.scene.add(i),this.remotePlayers.set(t.id,i),this.remotePlayerModels.set(t.id,n),this.hitboxSystem.registerPlayer(t.id,n),n.setGlowEffect(!0),i}removeRemotePlayer(t){this.scene.remove(t);for(const[e,n]of this.remotePlayers.entries())if(n===t){this.hitboxSystem.unregisterPlayer(e);const i=this.remotePlayerModels.get(e);i&&(i.dispose(),this.remotePlayerModels.delete(e)),this.remotePlayers.delete(e);break}}showRemoteShot(t){if(this.bulletSystem){const e=this.bulletSystem.createTrail(t.position,t.direction);e&&(this.scene.add(e),setTimeout(()=>this.scene.remove(e),100))}}showHitEffect(){const t=document.createElement("div");t.style.cssText=`
      position: fixed;
      top: 0;
      left: 0;
      width: 100%;
